// we use this to test the compiler
// the only modification made to this header
// are these 4 lines of comments, so the parser
// can take it as input without any problem
