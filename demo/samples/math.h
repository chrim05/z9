...
// (crim): modification made (commented these 3 lines) because what the hell
//         is _defs.h and i don't think i need it for testing
//         the parser
//
...
// (crim): modification made (removed _FARFUNC and _FAR) because
//         i have no idea what they are and found nothing inside _defs.h;
//         in addition, searching for them on google gives me 0 significative results
#ifdef __cplusplus
extern "C" {
#endif
