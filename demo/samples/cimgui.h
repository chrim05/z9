// header from
// https://github.com/cimgui/cimgui/blob/docking_inter/cimgui.h
//
// this header contains a minute modification, search for `(crim):`
...
// (crim): i commented this line
//         because i don't need stdio.h
//         to parse this header, and
//         i didn't write mine yet
//
// #include <stdio.h>
#include <stdint.h>
...
// (crim): c0 doesn't handle `__int64` correctly,
...
// (crim): clang-cpp defaults are a bit messed up
//
